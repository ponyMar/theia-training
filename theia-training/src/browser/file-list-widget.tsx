...
export class FileComponent extends React.Component<FileComponent.Props> {
    render(): React.ReactNode {
        let icon = this.props.labelProvider.getIcon(this.props.file);
        let style = {display: 'block'};
        return <div style={style} className={icon} onClick={this.openFile}>{this.props.labelProvider.getName(this.props.file)}</div>;
    }
