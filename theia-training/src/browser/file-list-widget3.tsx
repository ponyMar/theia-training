...
export class FileComponent extends React.Component<FileComponent.Props> {
    ...
    render(): React.ReactNode {
        let icon = this.props.labelProvider.getIcon(new URI(this.props.uri));
        let style = {display: 'block'};
        return <div style={style} className={icon} onClick={this.openFile}>{this.props.labelProvider.getName(new URI(this.props.uri))}</div>;
    }
...
@injectable()
export class FileListWidget3 extends ReactWidget implements StatefulWidget {
